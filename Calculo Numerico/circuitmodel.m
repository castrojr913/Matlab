...
clear %borrar variables de memoria
fid=fopen('c:\analisis_numerico\sistema.txt');
nnz=0;%contador de todos los valores no nulos en la matriz
k=1;%contador para las posiciones del termino indep.
while ~feof(fid)%ciclo que leer línea a línea hasta el final del archivo
...
return %retornar valores de argumentos de salida de la función