...
clear
syms s
disp('Funcion Transferencia Ecuación 3.a)')
...
disp('Funcion Transferencia Ecuación 3.b)')
...
figure(2)
pzmap(v1,v2)%grafica polos y ceros
disp('Funcion Transferencia Ecuación 3.c)')
...
figure(3)
pzmap(v1,v2)%grafica polos y ceros
disp('Funcion Transferencia Ecuación 3.d)')
